...
import profile from '../../assets/Bipanjit-Singh-full-stack-frontend-web.png';
    ...
    >
        ...
        <div className='flex flex-col-reverse md:flex-row justify-between gap-x-9 items-center '>
            ...
            about problem-solving, learning, and leveraging AI tools to speed up development and build efficient solutions.
                  ...
                  target='_blank'
                  title="Bipanjit Singh Bajwa Full Stack Developer Resume"
            ...
            <img src={profile} alt='Bipanjit Singh Bajwa| Full Stack Developer | Frontend Developer | Web Developer'
            className='h-full w-full rounded-full  object-cover' title="Bipanjit Singh Bajwa- Full Stack Developer"/>
            </Tilt>
            </div>
            </div>
        </div>
